...
export default function AdminHome() {
  ...
  const cards = [
    { href: "/categories", label: "Categories", icon: Tag, value: categories.length },
    { href: "/menu", label: "Menu items", icon: Soup, value: menuItems.length },
    { href: "/packages", label: "Packages", icon: PackageIcon, value: packages.length },
    { href: "/tables", label: "Tables", icon: UtensilsCrossed, value: tables.length },
    { href: "/staff", label: "Staff accounts", icon: Users, value: staff.length },
    { href: "/reports/staff", label: "Staff performance", icon: BarChart3, value: "View" },
    {
      href: "/reports/sales",
      label: "Sales reports",
      icon: Wallet,
